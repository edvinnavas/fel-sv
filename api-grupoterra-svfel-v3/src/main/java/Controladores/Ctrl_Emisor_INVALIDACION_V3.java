...
public class Ctrl_Emisor_INVALIDACION_V3 implements Serializable {
    ...
    public Emisor_invalidacion obtener_emisor_invalidacion_v3(Long id_contigencia, Connection conn) {
        ...
        try {
            ...
            resultado.setCodPuntoVenta(ctrl_base_datos.ObtenerString("SELECT F.CODPUNTOVENTA FROM EMISOR_ESTABLECIMIENTO_V3 F WHERE F.CODPUNTOVENTA=" + mcu_jde + " AND F.ID_EMISOR=" + id_emisor, conn));
