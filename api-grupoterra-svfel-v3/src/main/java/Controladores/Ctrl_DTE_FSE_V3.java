...
public class Ctrl_DTE_FSE_V3 implements Serializable {

    private static final long serialVersionUID = 1L;

    public Ctrl_DTE_FSE_V3() {
    }

    public List<Long> extraer_documento_jde_fse_v3(String ambiente) {
        ...
        try {
            ...
            while (rs.next()) {
                Long ID_DTE = ctrl_base_datos.ObtenerLong("SELECT NVL(MAX(F.ID_DTE), 0) + 1 MAXIMO FROM DTE_FSE_V3 F", conn);
                ...
                cadenasql = "INSERT INTO DTE_FSE_V3 ("
                        + "ID_DTE, "
                        + "KCOO_JDE, "
                        + "MCU_JDE, "
                        + "DOCO_JDE, "
                ...
                Ctrl_Identificacion_FSE_V3 ctrl_identificacion_fse_v3 = new Ctrl_Identificacion_FSE_V3();
                ...
                Ctrl_Apendice_FSE_V3 ctrl_apendice_fse_v3 = new Ctrl_Apendice_FSE_V3();
                String result_apendice = ctrl_apendice_fse_v3.extraer_apendice_jde_fse_v3(ID_DTE, ambiente, DOCO_JDE.trim(), DCTO_JDE.trim(), MCU_JDE.trim(), conn);
            ...
            try {
                ...
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:extraer_documento_jde_fse_v3()|ERROR:" + ex.toString());
                resultado.clear();
            } catch (Exception ex1) {
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:extraer_documento_jde_fse_v3()-rollback|ERROR:" + ex1.toString());
                resultado.clear();
            }
            ...
            try {
                ...
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:extraer_documento_jde_fse_v3()-finally|ERROR:" + ex.toString());
                resultado.clear();
            }
        }
    ...
    public DTE_FSE_V3 generar_json_dte_fse_v3(String ambiente, Long id_dte) {
        DTE_FSE_V3 resultado = new DTE_FSE_V3();
        Connection conn = null;
        ...
        try {
            ...
            Ctrl_Identificacion_FSE_V3 ctrl_identificacion_fse_v3 = new Ctrl_Identificacion_FSE_V3();
            resultado.setIdentificacion(ctrl_identificacion_fse_v3.obtener_identificacion_fse_v3(id_dte, conn));

            Ctrl_Emisor_FSE_V3 ctrl_emisor_fse_v3 = new Ctrl_Emisor_FSE_V3();
            ...
            Ctrl_Resumen_FSE_V3 ctrl_resumen_fse_v3 = new Ctrl_Resumen_FSE_V3();
            resultado.setResumen(ctrl_resumen_fse_v3.obtener_resumen_fse_v3(id_dte, conn));

            Ctrl_Apendice_FSE_V3 ctrl_apendice_fse_v3 = new Ctrl_Apendice_FSE_V3();
            resultado.setApendice(ctrl_apendice_fse_v3.obtener_apendice_fse_v3(id_dte, conn));
            ...
            try {
                ...
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:generar_dte_fse_v3()|ERROR:" + ex.toString());;
            } catch (Exception ex1) {
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:generar_dte_fse_v3()-rollback|ERROR:" + ex.toString());
            }
        } finally {
            try {
                if (conn != null) {
                ...
                System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:generar_dte_fse_v3()-finally|ERROR:" + ex.toString());
            }
        }
    ...
    public void registro_db_respuesta_mh(String ambiente, RESPUESTA_RECEPCIONDTE_MH respuesta_recepciondte_mh, Long id_dte) {
        ...
        try {
            ...
            String cadenasql = "UPDATE DTE_FSE_V3 SET "
            ...
            String NUMEROCONTROL = ctrl_base_datos.ObtenerString("SELECT F.NUMEROCONTROL FROM IDENTIFICACION_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String KCOO_JDE = ctrl_base_datos.ObtenerString("SELECT F.KCOO_JDE FROM DTE_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String DOCO_JDE = ctrl_base_datos.ObtenerString("SELECT F.DOCO_JDE FROM DTE_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String DCTO_JDE = ctrl_base_datos.ObtenerString("SELECT F.DCTO_JDE FROM DTE_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String DOC_JDE = ctrl_base_datos.ObtenerString("SELECT F.DOC_JDE FROM DTE_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String DCT_JDE = ctrl_base_datos.ObtenerString("SELECT F.DCT_JDE FROM DTE_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            String AEXP_JDE = ctrl_base_datos.ObtenerString("SELECT REPLACE(TO_CHAR(F.TOTALPAGAR,'9999999999D99MI'),'.','') AEXP_JDE FROM RESUMEN_FSE_V3 F WHERE F.ID_DTE=" + id_dte, conn);
            ...
            if (respuesta_recepciondte_mh.getCodigoMsg().trim().equals("001") || respuesta_recepciondte_mh.getCodigoMsg().trim().equals("002") || respuesta_recepciondte_mh.getCodigoMsg().trim().equals("CCC")) {
                ...
                File TargetFile;
                if (ambiente.equals("PY")) {
                     inputstream = cliente_rest_jasper.reporte_fse_pdf(id_dte.toString());
                     TargetFile = new File("/FELSV3/pdf/felsv_fse_" + id_dte + ".pdf");
                } else {
                    inputstream = cliente_rest_jasper.reporte_fse_pdf_prod(id_dte.toString());
                    TargetFile = new File("/FELSV3/pdf_pd/felsv_fse_" + id_dte + ".pdf");
                }
                ...
                File TargetFileJson;
                if (ambiente.equals("PY")) {
                    TargetFileJson = new File("/FELSV3/json/jsondte_fse_" + id_dte + ".json");
                } else {
                    TargetFileJson = new File("/FELSV3/json_pd/jsondte_fse_" + id_dte + ".json");
                }
                ...
                Adjunto adjunto_json = new Adjunto();
                adjunto_json.setName("jsondte_fse_" + id_dte + ".json");
                adjunto_json.setType("application/json");
                InputStream inputstream_mail_json = new FileInputStream(TargetFileJson);
                byte[] bytes_json = IOUtils.toByteArray(inputstream_mail_json);
                adjunto_json.setData(Base64.getEncoder().encodeToString(bytes_json));
    ...
    public Long obtener_id_dte_codigo_generacion(String ambiente, String codigogeneracion) {
        ...
        try {
            ...
            conn.setAutoCommit(false);
            resultado = ctrl_base_datos.ObtenerLong("SELECT F.ID_DTE FROM DTE_FSE_V3 F WHERE F.RESPONSE_ESTADO='EMITIDO-CONTIGENCIA' AND F.RESPONSE_CODIGOGENERACION='" + codigogeneracion + "'", conn);
            conn.commit();
            conn.setAutoCommit(true);
        } catch (Exception ex) {
            try {
