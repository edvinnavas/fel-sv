    ...
    public void registro_db_respuesta_mh(String ambiente, RESPUESTA_RECEPCIONDTE_MH respuesta_recepciondte_mh, Long id_dte) {
        ...
        try {
            ...
            if (respuesta_recepciondte_mh.getCodigoMsg().trim().equals("001") || respuesta_recepciondte_mh.getCodigoMsg().trim().equals("002") || respuesta_recepciondte_mh.getCodigoMsg().trim().equals("CCC")) {
                ...
                File TargetFile;
                if (ambiente.equals("PY")) {
                    inputstream = cliente_rest_jasper.reporte_fex_pdf(id_dte.toString());
                    TargetFile = new File("/FELSV3/pdf/felsv_fex_" + id_dte + ".pdf");
                } else {
                    inputstream = cliente_rest_jasper.reporte_fex_pdf_prod(id_dte.toString());
                    TargetFile = new File("/FELSV3/pdf_pd/felsv_fex_" + id_dte + ".pdf");
                }
                ...
                File TargetFileJson;
                if (ambiente.equals("PY")) {
                    TargetFileJson = new File("/FELSV3/json/jsondte_fex_" + id_dte + ".json");
                } else {
                    TargetFileJson = new File("/FELSV3/json_pd/jsondte_fex_" + id_dte + ".json");
                }
