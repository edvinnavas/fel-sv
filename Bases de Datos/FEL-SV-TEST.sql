...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (418);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (418);
-- ***************************************************************************************************************************
-- *          NOTA DE CRÉDITO.                                                                                               *
-- ***************************************************************************************************************************
...
SELECT F.* FROM DTE_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM IDENTIFICACION_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM RECEPTOR_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM SHIPTO_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM OTROS_DOCU_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM VENTA_TERCERO_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM CUERPO_DOCU_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM CUERPO_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM RESUMEN_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM RESUMEN_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM EXTENSION_FEX_V3 F WHERE F.ID_DTE IN (175);
SELECT F.* FROM APENDICE_FEX_V3 F WHERE F.ID_DTE IN (175);
-- ***************************************************************************************************************************
-- *          NOTA DE REMISION.                                                                                              *
-- ***************************************************************************************************************************
...
SELECT F.* FROM EVENTO_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (16);
SELECT F.* FROM IDENTIFICACION_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (16);
SELECT F.* FROM DETALLE_DTE_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (16);
SELECT F.* FROM MOTIVO_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (16);

SELECT F.* FROM DTE_NR_V3 F WHERE F.RESPONSE_CODIGOGENERACION='ABD2D145-BE56-471A-B0EB-75C7CA09CBB2';


SELECT F.* 
FROM DETALLE_DTE_CONTINGENCIA_V3 F 
WHERE F.ID_CONTINGENCIA=16;