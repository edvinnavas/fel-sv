...
SELECT F.* FROM DTE_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM IDENTIFICACION_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM DOCU_RELA_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM SUJETOEXCLUIDO_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM OTROS_DOCU_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM VENTA_TERCERO_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM CUERPO_DOCU_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM CUERPO_TRIBUTO_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM RESUMEN_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM RESUMEN_TRIBUTO_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM EXTENSION_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
SELECT F.* FROM APENDICE_FSE_V3 F WHERE F.ID_DTE IN (1,2,3,4,5);
-- ***************************************************************************************************************************
...
SELECT F.* FROM EVENTO_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (23);
SELECT F.* FROM IDENTIFICACION_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (23);
SELECT F.* FROM DETALLE_DTE_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (23);
SELECT F.* FROM MOTIVO_CONTINGENCIA_V3 F WHERE F.ID_CONTINGENCIA IN (23);
-- ***************************************************************************************************************************
...
-- ***************************************************************************************************************************
SELECT TO_NUMBER(SUBSTR(TO_CHAR(TO_DATE('01/09/2023','dd/MM/yyyy'),'ccYYddd'),2,6)) FECHA_JULIANA FROM DUAL;
SELECT TO_CHAR(TO_DATE(TO_CHAR(A.SDIVD + 1900000,'9999999'),'YYYYDDD'),'dd/MM/yyyy') FECHA_GREGORIANA FROM DUAL;

SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='FS';