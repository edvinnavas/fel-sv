...
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (418,417);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (418,417);
-- ***************************************************************************************************************************
-- *          NOTA DE CRÉDITO.                                                                                               *
-- ***************************************************************************************************************************
