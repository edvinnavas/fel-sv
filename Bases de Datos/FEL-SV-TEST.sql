...
SELECT F.FEDCTO FROM CRPDTA.F5542FEL@JDEPY F WHERE TRIM(F.FECRSREF02)='7CD7BA30-B1D9-4B2B-85C9-A4A3D3EFED81';
SELECT F.DTE_VERSION FROM IDENTIFICACION_FEX_V3 F WHERE F.CODIGOGENERACION='7CD7BA30-B1D9-4B2B-85C9-A4A3D3EFED81';

SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO=72960242 AND F.FEDCTO='EX';
UPDATE CRPDTA.F5542FEL@JDEPY SET FERCD='000' WHERE FEDOCO=72960242 AND FEDCTO='EX';
COMMIT;