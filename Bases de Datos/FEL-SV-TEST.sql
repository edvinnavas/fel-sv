...
SELECT F.* FROM IDENTIFICACION_FSE_V3 F WHERE F.ID_DTE IN (20);
...
SELECT F.* FROM RESUMEN_FSE_V3 F WHERE F.ID_DTE IN (20);
...
-- ***************************************************************************************************************************
SELECT TO_NUMBER(SUBSTR(TO_CHAR(TO_DATE('16/10/2023','dd/MM/yyyy')-20,'ccYYddd'),2,6)) FECHA_JULIANA FROM DUAL;
